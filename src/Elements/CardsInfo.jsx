...
export const CardsInfo = ({title1, img1, title2, img2}) => {
  return (
    <div className='flex flex-col items-center'>
      <div className='CardInfo max-h-fit p-10 flex flex-wrap justify-start w-full mb-10 md:w-3/12 flex-row rounded border-gray-950 bg-cover text-white h-80 m-5 '  style={{backgroundImage: `url(${img1})`}}>
      ...
      <div className='CardInfo max-h-fit p-5 flex flex-wrap justify-start w-full md:w-3/12 flex-row rounded border-gray-950 bg-cover text-white h-80 m-5'  style={{backgroundImage: `url(${img2})`}}>
        <div className="text-organizer flex flex-col justify-center items-center">
